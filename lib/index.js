...
class Gimlet {
  ...
  // Gets all installed storage plugins
  ...
  async getStoragePluginByName(name) {
    ...
    let response = instance.get(`storage/${encodeURIComponent(name)}.json`);
  ...
  async enableStoragePluginByName(name) {
    ...
    let response = instance.get(`storage/${encodeURIComponent(name)}/enable/true.json`);
  ...
  async disableStoragePluginByName(name) {
    ...
    let response = instance.get(`storage/${encodeURIComponent(name)}/enable/false.json`);
  ...
  async createStoragePluginByName(definition) {
    ...
    let response = instance.post(`storage/${encodeURIComponent(name)}.json`, definition);
  ...
  // Deletes a storage plugin by name
  async deleteStoragePluginByName(name) {
    let data = null;
    const instance = await this._getAxiosInstance();

    let response = instance.delete(`storage/${encodeURIComponent(name)}.json`);
  ...
  */
  ...
  // Check if a specific storage plugin exists
